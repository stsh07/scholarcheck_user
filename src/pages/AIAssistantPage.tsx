...
export default function AIAssistantPage() {
  ...
  return (
    <Layout>
      {/* Full-height container, page not scrollable */}
      <div className="flex flex-col h-screen p-6 overflow-hidden bg-gray-50">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          >
            ...
            <span className="text-sm font-medium text-green-800">History</span>
          </button>
        </div>
        ...
        >
          ...
          <p className="px-3 pb-2 pt-1 text-center text-xs text-[#565656]">
            IskoBot is an AI assistant that can only answer questions about the scholarship. It cannot respond to unrelated topics.
          </p>
        </div>
